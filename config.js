...
const CONFIG = {
  ...
  // ─── 정당 컬러 ───
  // 더불어민주당: "#003B96"  |  국민의힘: "#E61E2B"
  // 조국혁신당: "#0073CF"  |  진보당: "#D6001C"
  // 개혁신당: "#FF7210"  |  사회민주당: "#F58400"
  color: "#003B96",
  ...
  // ─── 후원 계좌 ───
  // 필요 없으면 아래 두 줄 앞에 // 붙이면 숨겨짐
  donation: {
    account: "농협 301-0380-6259-41",
    holder: "예금주: 이용기 후원회(경상북도교육감선거)",
  },
